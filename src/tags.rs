...
macro_attr! {
    ...
    #[repr(u32)]
    pub enum RSCP {
        // LIST_NON_PAIRED_DEVICE_TYPE_EVCS = 0x000000, // assume this is a bug -> EEBUS::LIST_NON_PAIRED_DEVICE_TYPE_EVCS
        ...
        // EMOBILITY_GET_OVERLOAD_CHARGING_CURRENT_LIMIT_PER_PHASE = 0x010021, assume this is a bug -> EEBUS::EMOBILITY_WB_EV_GET_OVERLOAD_CHARGING_CURRENT_LIMIT
...
macro_attr! {
    ...
    pub enum EMS {
        ...
        SET_POWER = 0x000030,
        SET_POWER_MODE = 0x000031,
        SET_POWER_VALUE = 0x000032,
...
macro_attr! {
    ...
    pub enum BAT {
        ...
        SET_A1_MODE = 0x000029,
        DELETE_DCB_TYPE = 0x00002a,
        DCB_TYPE = 0x00002b,
        SET_A1_VOLTAGE = 0x000030,
        SET_A1_CURRENT = 0x000031,
...
macro_attr! {
    ...
    pub enum DCDC {
        ...
        SET_PVI_TYPE = 0x000078,
        PVI_TYPE = 0x000079,
        ON_GRID = 0x000080,
        SET_ON_GRID = 0x000081,
        NEXT_SLAVE_STATE = 0x000082,
        ENABLE_NEXT_SLAVE = 0x000083,
        DCDC_TYPE = 0x000084,
        ...
        ENABLE_FAN_TEST = 0x040061,
        DISABLE_FAN_TEST = 0x040062,
        DEVICE_STATE = 0x060000,
        DEVICE_CONNECTED = 0x060001,
        DEVICE_WORKING = 0x060002,
        DEVICE_IN_SERVICE = 0x060003,
...
macro_attr! {
    ...
    pub enum INFO {
        ...
        LC_SET_TIME = 0x000043,
        LC_GET_IS_TIME_SYNCHRO = 0x000044,
        LC_GET_SYSTEM_TIME = 0x000045,
        LC_GET_TIME_TIMEZONE = 0x000046,
...
macro_attr! {
    ...
    pub enum UM {
        ...
        LC_SET_START_FILE_TRANSFER = 0x000004,
        LC_SET_FILE_TRANSFER = 0x000005,
        LC_SET_END_FILE_TRANSFER = 0x000006,
        LC_PARAM_TOKEN = 0x400001,
        LC_PARAM_STATUS = 0x400002,
...
macro_attr! {
    ...
    pub enum WB {
        ...
        PM_DEVICE_STATE_WORKING = 0x000031,
...
macro_attr! {
    ...
    pub enum SCM {
        SET_CONFIG = 0x000001,
        ACCEPTED_CONFIG_FILE_VERSION = 0x000002,
        ...
        LC_GET_TYPE_MEASURE = 0x000007,
        LC_GET_POWER_MGT_CONFIG = 0x000008,
        LC_SET_TYPE_MEASURE = 0x000009,
        LC_SET_POWER_MGT_CONFIG = 0x00000a,
        CONFIG_ID = 0x400001,
...
macro_attr! {
    ...
    pub enum EEBUS {
        ...
        APPLY_WB_PRECONFIG = 0x000007,
        LIST_USECASE = 0x000008,
        EMOBILITY_WB_GET_EVSE_LIST_USECASE = 0x010000,
        EMOBILITY_WB_EV_GET_EV_LIST_USECASE = 0x010001,
        EMOBILITY_WB_GET_EVSE_MANUFACTURER_INFO = 0x010002,
        EMOBILITY_WB_EV_GET_EV_MANUFACTURER_INFO = 0x010003,
        EMOBILITY_WB_EV_GET_CHARGING_POWER_LIMITS = 0x010004,
        EMOBILITY_WB_EV_GET_IDENTIFICATION = 0x010005,
        EMOBILITY_WB_EV_GET_SLEEP_MODE = 0x010006,
        EMOBILITY_WB_EV_GET_ASYMMETRIC_CHARGING_SUPPORTED = 0x010007,
        EMOBILITY_WB_EV_GET_COMMUNICATION_STANDARD = 0x010008,
        EMOBILITY_WB_EV_GET_CURRENT_MEASUREMENT_CONSTRAINTS = 0x010010,
        EMOBILITY_WB_EV_GET_POWER_MEASUREMENT_CONSTRAINTS = 0x010011,
        EMOBILITY_WB_EV_GET_ENERGY_MEASUREMENT_CONSTRAINTS = 0x010012,
        EMOBILITY_WB_EV_GET_CHARGING_MEASUREMENT_CONSTRAINTS = 0x010013,
        EMOBILITY_WB_EV_GET_CHARGING_CURRENT_MEASUREMENT = 0x010014,
        EMOBILITY_WB_EV_GET_CHARGING_POWER_MEASUREMENT = 0x010015,
        EMOBILITY_WB_EV_GET_CHARGING_ENERGY_MEASUREMENT = 0x010017,
        EMOBILITY_WB_EV_GET_CHARGING_MEASUREMENT = 0x010018,
        EMOBILITY_WB_EV_GET_CHARGING_CURRENT_CONSTRAINTS = 0x010020,
        EMOBILITY_WB_EV_GET_OVERLOAD_CHARGING_CURRENT_LIMIT = 0x010021,
        EMOBILITY_WB_EV_GET_DATA = 0x01fffe,
        EMOBILITY_WB_GET_DATA = 0x01ffff,
...
macro_attr! {
    ...
    pub enum LCT {
        ...
        SD_GET_MEM_INFO = 0x000005,
        SD_GET_MOF_HEAP = 0x000006,
        SD_GET_UP_TIME = 0x000007,
...
macro_attr! {
    ...
    pub enum UMRC {
        ...
        CREATE_FOLDER = 0x000107,
        APPEND_FILE_CONTENT = 0x000108,
        RENAME_FILE = 0x000109,
        DELETE_FILE = 0x00010d,
        DELETE_FOLDER = 0x00010e,
        SHOW_MSG = 0x00010f,
...
macro_attr! {
    ...
    pub enum DBRC {
        ...
        DEVICE_LIST = 0x00a001,
        USER_DATA = 0x00a002,
        ADDRESS = 0x00a003,
        REQ_MY_PERMISSIONS = 0x00a004,
        LOCK_DEVICE = 0x00a005,
        UNLOCK_DEVICE = 0x00a006,
        LOCK_STATE = 0x00a007,
        UPDATE_MACROS = 0x00a008,
        MACROS = 0x00a009,
...
macro_attr! {
    ...
    pub enum SYS_CMD {
        ...
        REGISTER_REMOTE_DEBUG = 0x000016,
        UNREGISTER_REMOTE_DEBUG = 0x000017,
        ALL_DEBUG_DEVICES = 0x000018,
        ADD_DEBUG_DEVICE = 0x000019,
        SET_LEVEL = 0x000020,
        REMOVE_DEBUG_DEVICE = 0x000021,
        LOG_MSG = 0x000022,
        REQ_INLINE_SYS_EXECUTE = 0x000023,
        REQ_VIRTUAL_CONNECTIONS = 0x000024,
        REQ_SYS_EXECUTE_INTERACTIVE = 0x000026,
        REGISTER_SYS_OBSERVER = 0x000100,
        UNREGISTER_SYS_OBSERVER = 0x000101,
        ...
        APPEND_FILE_CONTENT = 0x000108,
        RENAME_FILE = 0x000109,
        CREATE_SYM_LINK = 0x00010b,
        DELETE_FILE = 0x00010d,
        DELETE_FOLDER = 0x00010e,
        REGISTER_PROC_OBS = 0x000200,
        REQ_PROC_ID = 0x000203,
        REQ_PROC_FILE = 0x000204,
        REQ_PROC_LIST = 0x000205,
        UNREGISTER_PROC_OBS = 0x000206,
...
macro_attr! {
    ...
    pub enum DB_SERVICE {
        ...
        SYNC_CONFIG_PROPERTIES = 0x00e003,
        GENERAL_ERROR = 0x7fffff
    }
}
